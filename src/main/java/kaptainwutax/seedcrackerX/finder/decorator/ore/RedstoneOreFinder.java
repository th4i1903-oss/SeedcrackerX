...
public class RedstoneOreFinder extends BlockFinder {

    protected static List<BlockPos> SEARCH_POSITIONS;

    public RedstoneOreFinder(Level world, ChunkPos chunkPos) {
        super(world, chunkPos, Blocks.REDSTONE_ORE);
    ...
    public static List<Finder> create(Level world, ChunkPos chunkPos) {
        ...
        finders.add(new RedstoneOreFinder(world, chunkPos));
        return finders;
    }
